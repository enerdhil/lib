...
TEST(version_1) {
	TEST_ASSERT((get_version() == NULL), "Wrong program name init");
	return TEST_SUCCESS;
}

TEST(version_2) {
	set_version("Hey !");
	TEST_ASSERT(strcmp(get_version(), "Hey !") == 0, "Wrong program_name return");
	return TEST_SUCCESS;
}
...
TEST(version_3) {
	TEST_ASSERT(strcmp(get_version(), "Hey !") == 0, "Wrong program_name return");
	set_version("Yo !");
	TEST_ASSERT(strcmp(get_version(), "Yo !") == 0, "Wrong program_name return");
	return TEST_SUCCESS;
}
...
TEST(version_4) {
	TEST_ASSERT(strcmp(get_version(), "Yo !") == 0, "Wrong program_name return");
	set_version("");
	TEST_ASSERT((get_version() == NULL), "Wrong program_name return");
	set_version(NULL);
	TEST_ASSERT((get_version() == NULL), "Wrong program_name return");
	return TEST_SUCCESS;
}
